...
# 0 * * * * dev/2021-07-10-august-door-lock/notify-if-unlocked/cron-runner.sh >> dev/2021-07-10-august-door-lock/notify-if-unlocked/cron-output 2>&1
...
cd ~/dev/2021-07-10-august-door-lock/notify-if-unlocked || exit 1
